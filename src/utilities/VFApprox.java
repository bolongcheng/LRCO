...
//		num_subs = param.get_num_subs();
    ...
    public float getVApprox(int R, int G, int D) {
        ...
        int GDIndex = G + D * (param.getGrange().length);
        int colIndex = GDIndex / sizeCol;
        int subGD = GDIndex % sizeCol;
        ...
        return (float) (x[subR][rowIndex][colIndex] * y[subGD][rowIndex][colIndex] - shift[rowIndex][colIndex]);
    }
